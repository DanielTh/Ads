            ...
            <?php
                ...
                try
                {
                    ...
                    if($res){
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div id="image"><img src="images_annonces/$res[imageAnnonce]" onerror="this.src='http://pingendo.github.io/pingendo-bootstrap/assets/placeholder.png';" class="center-block"></div>
